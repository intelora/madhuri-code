...
function add_customer_enq($fullname, $emailid, $contactno, $cstatus)
{
    $pdo = Database::connect();
    $sql = "INSERT INTO joinenq (`id`, `fullname`, `emailid`, `contactno`, `datetime`, `cstatus`)  VALUES(NULL,'{$fullname}','{$emailid}','{$contactno}',CURRENT_TIMESTAMP,'{$cstatus}')";
    $status = [];
//    echo "{ \"sql\":\"{$sql}\" }";
    try {
