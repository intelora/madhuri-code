...
const Home = () => {
    ...
    const handleSubmit = () => {
        ...
        if (!errors.email && !errors.name) {
            setOpenModal(false)
            fetch(
                'https://intelora.co.in/api/rest/musicnftapi/customerenq_services.php',
                {
                    method: 'POST',
                    headers: {
                        ...
                        <div className='col-lg-12' style={{ zIndex: '1' }}>
                            <div className='row align-items-center py-5'>
                                ...
                                <div className='col-lg-5'>
                                    <div
                                        className='text-center main-gif'
                                        style={{ position: 'relative' }}
                                    >
                                        <img
                                            src='/images/musicbar.svg'
                                            className='rotate'
                                            alt=''
                                        />
                                        <div className='d-flex justify-content-around preview-top align-items-center '>
                                            ...
                                            <div className='d-flex justify-content-around'>
                                                <div
                                                    className='d-flex align-items-center play-btn-action  p-2'
                                                    style={{ width: '40px' }}
                                                >
                                                    <img
                                                        src='/images/prev.svg'
