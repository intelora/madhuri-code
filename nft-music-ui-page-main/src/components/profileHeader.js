      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse justify-content-end" id="navbarText">
          <ul className="navbar-nav nav mr-auto">
            ...
            <li className="nav-item">
              <a className="nav-link active" href="#preview">About</a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="#info">Buy</a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="#breakdown">BreakDown</a>
            </li>
            <li className="nav-item">
              <a className="custom-nav-btn" id="connect-wallet" href="create-wallet">
                Create Wallet
              </a>
            </li>
            {
